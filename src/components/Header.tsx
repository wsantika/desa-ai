...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-slate-200/80 bg-white/95 px-4 backdrop-blur-md dark:border-slate-800 dark:bg-slate-900/95">
      <nav className="mx-auto flex max-w-7xl items-center justify-between gap-2 sm:gap-4 py-2 sm:py-3">
        {/* Brand & Village Identity */}
        <div className="flex items-center gap-2 sm:gap-4 lg:gap-6 min-w-0">
          <Link
            to="/"
            className="inline-flex shrink-0 items-center gap-2 rounded-full border border-slate-200 bg-white px-2.5 py-1.5 text-xs sm:text-sm font-bold text-slate-900 no-underline shadow-xs hover:border-blue-300 dark:border-slate-700 dark:bg-slate-800 dark:text-white sm:px-4 sm:py-2 whitespace-nowrap"
          >
        ...
        <div className="flex items-center gap-1.5 sm:gap-3 shrink-0">
          ...
          <a
            href="tel:0361123456"
            className="inline-flex min-h-[38px] min-w-[38px] shrink-0 items-center justify-center gap-1.5 rounded-full border border-slate-200 bg-white p-2 text-xs font-semibold text-slate-700 shadow-xs transition hover:border-blue-300 hover:bg-slate-50 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-200 dark:hover:bg-slate-700 sm:px-3 sm:py-1.5"
            title="Telepon Hotline Kantor Desa Tegal Tugu"
            aria-label="Telepon Hotline Kantor Desa Tegal Tugu"
          >
            <PhoneCall className="h-4 w-4 text-blue-700 dark:text-blue-400 shrink-0" aria-hidden="true" />
            <span className="hidden sm:inline">Darurat</span>
          </a>

          <Link
            to="/admin"
            className="hidden sm:inline-flex min-h-[38px] shrink-0 items-center gap-1.5 rounded-full border border-blue-700/20 bg-blue-700/10 px-2.5 py-1 text-xs font-semibold text-blue-800 whitespace-nowrap transition hover:bg-blue-700/20 dark:border-blue-500/30 dark:bg-blue-950/40 dark:text-blue-300 sm:px-3 sm:py-1.5"
