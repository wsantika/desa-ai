    ...
    <div className="flex flex-col gap-4 rounded-xl border border-[var(--line,#d5ded9)] bg-[var(--surface-primary,#ffffff)] p-4 shadow-xs dark:border-[#22352f] dark:bg-[#121c19] lg:flex-row lg:items-center lg:justify-between">
      ...
      <div className="flex flex-wrap items-center gap-2">
        <div className="flex items-center gap-1.5 text-xs font-semibold text-[var(--sea-ink-soft,#576c64)] dark:text-stone-400">
          <MapPin className="h-3.5 w-3.5 text-emerald-800 dark:text-emerald-400" />
        ...
        <div className="flex flex-wrap gap-1.5">
          <button
            ...
            className={`min-h-[44px] sm:min-h-[34px] rounded-lg px-3 py-1.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-emerald-800 ${
              selectedBanjar === 'ALL'
      ...
      <div className="flex flex-wrap items-center gap-2 lg:justify-end">
        <div className="flex items-center gap-1.5 text-xs font-semibold text-[var(--sea-ink-soft,#576c64)] dark:text-stone-400">
          <Calendar className="h-3.5 w-3.5 text-emerald-800 dark:text-emerald-400" />
        ...
        <select
          ...
          className="min-h-[44px] sm:min-h-[34px] rounded-lg border border-[var(--line,#d5ded9)] bg-[var(--surface-primary,#ffffff)] px-3 py-1.5 text-xs font-medium text-[var(--sea-ink,#1b2a26)] focus:border-emerald-800 focus:outline-none focus:ring-1 focus:ring-emerald-800 dark:border-[#22352f] dark:bg-[#121c19] dark:text-stone-200"
        ...
        >
          <RefreshCw
            className={`h-3.5 w-3.5 text-emerald-800 dark:text-emerald-400 ${
        ...
        <button
          type="button"
          onClick={onPrint}
          className="inline-flex min-h-[44px] sm:min-h-[34px] items-center gap-1.5 rounded-lg bg-emerald-800 px-3 py-1.5 text-xs font-bold text-white shadow-xs transition-colors hover:bg-emerald-900 focus:outline-none focus:ring-2 focus:ring-emerald-800 dark:bg-emerald-700 dark:hover:bg-emerald-600"
