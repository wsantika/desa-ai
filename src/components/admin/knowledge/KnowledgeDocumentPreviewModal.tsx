    ...
    >
      <div className="relative flex max-h-[90vh] w-full max-w-3xl flex-col rounded-2xl border border-slate-200 bg-white shadow-2xl dark:border-slate-800 dark:bg-slate-900">
        ...
        <div className="flex items-start justify-between border-b border-slate-200 p-5 dark:border-slate-800">
          <div className="space-y-1 pr-4">
            ...
            <h3
              ...
              className="m-0 text-base sm:text-lg font-bold text-slate-900 dark:text-slate-100"
            >
              {document.title}
            </h3>
        ...
        <div className="flex-1 space-y-6 overflow-y-auto p-5 text-xs">
          ...
          <div>
            <h4 className="mb-2 font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 text-[11px]">
              Isi Dokumen Acuan (Markdown)
            </h4>
            <div className="rounded-xl border border-slate-200 bg-slate-50 p-4 text-slate-800 dark:border-slate-800 dark:bg-slate-950/50 dark:text-slate-200">
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              <h4 className="m-0 font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 text-[11px]">
            ...
            {document.chunks && document.chunks.length > 0 ? (
                ...
                {document.chunks.map((c) => (
                  ...
                  >
                    <div className="flex items-center justify-between mb-1.5 text-[11px]">
                      <span className="inline-flex items-center gap-1 font-mono font-bold text-blue-600 dark:text-blue-400">
                    ...
                    <p className="m-0 font-mono text-[11px] text-slate-700 dark:text-slate-300 leading-relaxed bg-slate-50 dark:bg-slate-950/50 p-2 rounded">
                      {c.chunkContent}
                    </p>
                  </div>
                ))}
              ...
              <div className="rounded-lg border border-slate-200 bg-slate-50 p-4 text-center text-slate-500 dark:border-slate-800 dark:bg-slate-950/50 dark:text-slate-400">
        ...
        {/* Footer */}
        <div className="flex items-center justify-end gap-3 border-t border-slate-200 bg-slate-50 px-5 py-3 dark:border-slate-800 dark:bg-slate-900">
          <button
            type="button"
            onClick={onClose}
            className="rounded-lg border border-slate-200 bg-white px-4 py-2 text-xs font-semibold text-slate-700 hover:bg-slate-100 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-200"
          >
            Tutup
          </button>
          <button
