  ...
  return (
    <div className="mx-auto max-w-7xl space-y-6">
      <div className="flex items-center justify-between gap-4">
        <div>
          ...
          <h2 className="mt-2 mb-0 text-xl font-bold tracking-tight text-[var(--sea-ink,#1b2a26)] dark:text-stone-100">
            Meja Verifikasi dan Persetujuan Surat Layanan
          </h2>
          <p className="m-0 text-xs text-[var(--sea-ink-soft,#576c64)] dark:text-stone-400">
            Pemeriksaan dokumen persyaratan dan penerbitan persetujuan surat mandiri warga.
          </p>
        </div>
      </div>
      ...
      <div className="rounded-xl border border-dashed border-[var(--line,#d5ded9)] bg-[var(--surface-primary,#ffffff)] p-8 text-center dark:border-[#22352f] dark:bg-[#121c19]">
        <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-amber-100 text-amber-900 dark:bg-amber-950/60 dark:text-amber-300">
          <FileCheck className="h-6 w-6" />
        </div>
        <h3 className="mt-4 mb-1 text-base font-bold text-[var(--sea-ink,#1b2a26)] dark:text-stone-100">
          Alur Verifikasi Terhubung ke Basis Data Permohonan
        </h3>
        <p className="m-0 mx-auto max-w-md text-xs text-[var(--sea-ink-soft,#576c64)] dark:text-stone-400">
          Antrean permohonan surat warga terdata dalam sistem. Alur aksi persetujuan dan penolakan berkas siap diintegrasikan pada tahap berikutnya.
        </p>
        ...
        <div className="mt-6 flex justify-center gap-3">
          ...
          >
            <span>Buka Katalog Layanan Warga</span>
